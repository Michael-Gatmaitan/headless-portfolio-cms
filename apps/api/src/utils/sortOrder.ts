// License: CC0 (no rights reserved). Original by CCripwell: https://github.com/CRipwell/fractional-indexing
...
export async function nextSortOrder(lastSortOrder: string | null | undefined): Promise<string> {
